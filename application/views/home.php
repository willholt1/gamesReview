...
<div class="container">
    <div class="row">
        ...
        foreach ($result as $row){
            ...
            //display the name
            echo '<h1 class="display-4">'.$thisGameName.'</h1>';
            //display the cover
            echo '<img src="'.$image.'" alt="'.$thisGameName.' Cover" width="200" height="320">';
            echo '<br>';
            //link to review
            echo '<a class="btn btn-primary" href="index.php/review/'.$thisSlug.'" role="button">Full Review</a>';
            echo '<br>';
            //close the card div
            echo '</div>';
        }
